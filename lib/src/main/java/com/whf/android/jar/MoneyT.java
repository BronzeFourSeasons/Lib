...
public class MoneyT {
     ...
     */
    private static final String[] CN_UPPER_MONEY_UNIT = {
            "分", "角",
            "元", "拾", "佰", "仟",
            "万", "拾", "佰", "仟",
            "亿", "拾", "佰", "仟",
    ...
    public static String toMoney(double money) {
        ...
        return number2CNMoneyUnit(numberOfMoney);
    }
     ...
     * 把输入的金额转换为汉语中人民币的大写
     */
    private static String number2CNMoneyUnit(BigDecimal numberOfMoney) {
        try {
