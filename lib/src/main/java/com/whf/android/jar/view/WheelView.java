...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs, styleable.WheelView);
        unitHeight = (int) attribute.getDimension(styleable.WheelView_unitHeight, unitHeight);
        itemNumber = attribute.getInt(styleable.WheelView_itemNumber, itemNumber);

        normalFont = attribute.getDimension(styleable.WheelView_normalTextSize, normalFont);
        selectedFont = attribute.getDimension(styleable.WheelView_selectedTextSize, selectedFont);
        normalColor = attribute.getColor(styleable.WheelView_normalTextColor, normalColor);
        selectedColor = attribute.getColor(styleable.WheelView_selectedTextColor, selectedColor);

        lineColor = attribute.getColor(styleable.WheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(styleable.WheelView_lineHeight, lineHeight);

        maskHeight = attribute.getDimension(styleable.WheelView_maskHeight, maskHeight);
        noEmpty = attribute.getBoolean(styleable.WheelView_noEmpty, true);
        isEnable = attribute.getBoolean(styleable.WheelView_isEnable, true);
